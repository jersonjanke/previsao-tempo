...
app.controller("myCtrlTemp", function ($scope, $http) {
    ...
    $scope.carregaPrevisao = function (previsao, cidade, estado) {
        ...
        //Temperaturas Minima
        $scope.min00 = $scope.myData.previsoes[0].temperatura_min + ' °';
        $scope.min01 = $scope.myData.previsoes[1].temperatura_min + ' °';
        $scope.min02 = $scope.myData.previsoes[2].temperatura_min + ' °';
        $scope.min03 = $scope.myData.previsoes[3].temperatura_min + ' °';
        $scope.min04 = $scope.myData.previsoes[4].temperatura_min + ' °';

        //Temperatura Maxima
        $scope.max00 = $scope.myData.previsoes[0].temperatura_max + ' °';
        $scope.max01 = $scope.myData.previsoes[1].temperatura_max + ' °';
        $scope.max02 = $scope.myData.previsoes[2].temperatura_max + ' °';
        $scope.max03 = $scope.myData.previsoes[3].temperatura_max + ' °';
        $scope.max04 = $scope.myData.previsoes[4].temperatura_max + ' °';
